...
HD_PWD='D:/Projects/SOC_Projects/SPI_SLAVE_CORE/SPI_SLAVE_CORE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_SLAVE_CORE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_SLAVE_CORE.tcl -notrace
