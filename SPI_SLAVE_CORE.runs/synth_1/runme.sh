...
HD_PWD='D:/Projects/SOC_Projects/SPI_SLAVE_CORE/SPI_SLAVE_CORE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_SLAVE_CORE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_SLAVE_CORE.tcl
